...
describe("configuration", () => {
  test("loads valid configuration", () => {
    expect(loadConfig(validEnv)).toEqual({
      ...
      driverOfferSpinLimit: 30,
      driverOfferSpinWindowSeconds: 60,
      driverOfferClaimLimit: 20,
      driverOfferClaimWindowSeconds: 60,
      ...
      driverRuntimeHydrateLockTtlSeconds: 8,
      driverRuntimeHydrateWaitMs: 2000,
      driverRuntimeHydratePollMs: 50,
      driverLocationFreshSeconds: 120,
      driverOfferSpinAgeBucketMs: 60000,
      driverOfferSpinRotationWindowMs: 15000,
      redisReconEnabled: true,
      redisReconPollIntervalMs: 2000,
      redisReconBatchSize: 25,
      redisReconMaxAttempts: 12,
      redisReconRetryBaseMs: 1000,
      redisReconRetryMaxMs: 60000,
