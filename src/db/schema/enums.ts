...
export const customerProfileStatus = pgEnum("customer_profile_status", [
  "ACTIVE",
  "SUSPENDED",
  "CLOSED",
]);
...
export const staffProfileStatus = pgEnum("staff_profile_status", [
  "INVITED",
  "ACTIVE",
  "DISABLED",
  "CLOSED",
...
export const driverReviewAction = pgEnum("driver_review_action", [
  "REVIEWED",
  "CHANGES_REQUESTED",
  "APPROVED",
  "REJECTED",
...
export const staffRoleCode = pgEnum("staff_role_code", [
  "SUPER_ADMIN",
  "ADMIN",
  "OPERATIONS",
  "ACCOUNTANT",
...
export const mfaCredentialStatus = pgEnum("mfa_credential_status", [
  "PENDING",
  "ACTIVE",
  "RESET",
  "REMOVED",
...
export const governorateStatus = pgEnum("governorate_status", [
  "ACTIVE",
  "INACTIVE",
]);
...
export const mediaAssetVisibility = pgEnum("media_asset_visibility", [
  "PUBLIC",
  "PRIVATE",
]);
...
export const orderReturnWorkflowStatus = pgEnum(
  "order_return_workflow_status",
  [
