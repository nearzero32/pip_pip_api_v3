        ...
        query: t.Object(
          {
            ...
            paymentMethod: t.Optional(t.String({ examples: ["CASH"] })),
            paymentStatus: t.Optional(t.String()),
            totalMin: t.Optional(t.String()),
            totalMax: t.Optional(t.String()),
            storeCommissionRateMin: t.Optional(t.String()),
            storeCommissionRateMax: t.Optional(t.String()),
          },
          { additionalProperties: false },
        ),
