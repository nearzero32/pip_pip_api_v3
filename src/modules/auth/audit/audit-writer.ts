...
export const authAuditEvents = ["OTP_REQUESTED", "OTP_REQUEST_RATE_LIMITED", "OTP_VERIFICATION_SUCCEEDED", "OTP_VERIFICATION_FAILED", "OTP_CHALLENGE_EXHAUSTED", "CUSTOMER_SESSION_CREATED", "DRIVER_SESSION_REPLACED", "STAFF_LOGIN_SUCCEEDED", "STAFF_LOGIN_FAILED", "SESSION_REFRESHED", "REFRESH_TOKEN_REUSE_DETECTED", "SESSION_REVOKED", "ALL_SESSIONS_REVOKED", "AUTHENTICATION_STATE_DENIED"] as const;
