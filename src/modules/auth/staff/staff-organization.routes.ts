...
const employeeDto = t.Object({
  ...
  permissions: t.Array(
    t.Union([
      ...
      t.Literal("store_categories.read"),
      ...
      t.Literal("modifiers.read"),
      t.Literal("modifiers.create"),
      t.Literal("modifiers.update"),
      t.Literal("modifiers.archive"),
      t.Literal("merchants.read"),
      t.Literal("merchants.create"),
      t.Literal("merchants.update"),
      t.Literal("orders.read"),
      ...
      t.Literal("orders.assign"),
      t.Literal("orders.reoffer"),
      t.Literal("orders.handoff.manage"),
      t.Literal("orders.return.manage"),
      t.Literal("order_offers.read"),
      t.Literal("order_offers.manage"),
    ]),
  ),
  cityId: t.String({ format: "uuid" }),
  createdAt: t.String({ format: "date-time" }),
