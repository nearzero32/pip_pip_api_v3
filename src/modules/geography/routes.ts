...
const govResponse = paginated(govDto),
  cityResponse = paginated(cityDto),
  mobileCityResponse = paginated(mobileCity);
const errors = (extra: Record<number, any> = {}) => ({
  ...standardErrors,
  400: errorResponse,
  403: errorResponse,
  404: errorResponse,
  ...
  new Elysia({ name: "geography-routes" })
    ...
    .get(
      ...
      async ({ request, set, query }) => {
        ...
        return service.governorates(query);
      },
      {
        query: t.Object(
          {
        ...
        response: { 200: govResponse, ...errors() },
        detail: {
    ...
    .patch(
      ...
      async ({ request, set, params, body }) => {
        ...
        return service.updateGovernorate(id, params.governorateId, body);
      },
      {
        params: idParam,
        body: t.Object(
    ...
    .get(
      ...
      },
      {
        ...
        response: { 200: cityResponse, ...errors() },
        detail: {
          tags: ["Dashboard — Cities"],
          security: [{ bearerAuth: [] }],
        },
    ...
    .get(
      ...
      async ({ request, set, params }) => {
        await authIdentity(auth, request, dashboardContext, requestIdOf(set));
        return service.city(params.cityId);
      },
      {
        params: cityIdParam,
        response: { 200: cityDto, ...errors() },
    ...
    .get(
      ...
      async ({ request, set, query }) => {
        ...
        return service.cities({ ...query, mobile: true });
      },
      {
        query: t.Object(
          {
        ...
        response: { 200: mobileCityResponse, ...errors() },
        detail: {
